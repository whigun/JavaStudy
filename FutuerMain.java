...
public class FutuerMain {
      
	public static void main(String[]args) {
		ArrayList<FutureStudent> stuList = new ArrayList<>();
		stuList.add(new FutureStudent("이앞길", "lee apgil"));
		...
		stuList.add(new FutureStudent("김기찬", "kim gichanchan"));
...
//		                             stuB.getLevel() -stuA.getLevel());
		...
		//stuB.getLevel() - stuA.getLevel() stuB 학생과 stuA 학생의 값이
