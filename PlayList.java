	...
	public static void main(String[] args) {
		...
		// 4. 없으면 ... 아쉽지만 검색 결과가 없습니다..(출력)
		    ...
		    {Scanner scanner = new Scanner(System.in);
                 System.out.println("TOP100입니다. 가수와 제목을 어떤걸로 알려드릴까요?");
                 System.out.println(">>> ");
			...
			ArrayList<String> singer = searchSong(st, key,  playlist);
			System.out.println(searchList); 
            }
	          else if(st.equals("제목")) {
	          Scanner sc1 = new Scanner(System.in);
		      System.out.println("키워드를 입력해주세요!");
		      System.out.println(">>> ");
	          String key1 = sc1.nextLine();
	          ArrayList<String> singer = searchSong(st, key1, playlist);
	          System.out.println(searchList);
	          }
          }
	}
